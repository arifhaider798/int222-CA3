...
const AdminLogin = () => {
  ...
  // useForm only takes handleSubmit and register we cant change the variable name
  ...
  const handleLogin = async (data) => {
    ...
    try {
      ...
      if (userData) {
        ...
        Cookies.set("adminAccessToken", userData.accessToken);
      }
      console.log(Cookies.get("adminAccessToken"));
    } catch (error) {
  ...
  return (
    <div className=" bg-gradient-to-b from-neutral-900 to-neutral-950 h-full w-full flex flex-col gap-0 md:gap-8 items-center overflow-hidden overflow-y-auto">
      <div className="bg-black/80  text-white p-8 w-full">
        <img src="./../../../public/spotify.jpg" alt="spotify" className="h-24" />
